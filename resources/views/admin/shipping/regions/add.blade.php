        ...
        <div class="row">
            ...
            <div class="box">
                <div class="box-header with-border">
                    <h4 class="box-title">Add New Region</h4>
                </div>
                <!-- /.box-header -->
                <div class="box-body">
                    <div class="row">
                        ...
                        <div class="col">
                            <form action="{{ route('admin.shipping.store-region') }}" method="POST">
                                @csrf
                                ...
                                <div class="text-xs-right">
                                    <input type="submit" class="btn btn-rounded btn-info" value="Add Region" />
                                </div>
                            </form>
