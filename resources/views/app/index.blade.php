                                                    ...
                                                    <div class="row product-micro-row">
                                                        <div class="col col-xs-5">
                                                            <div class="product-image">
                                                                <div class="image"> <a
                                                                        href="{{ url('product-details/' . $offer->id . '/' . $offer->product_slug_en) }}">
                                                                        <img src="{{ asset($offer->product_thumbnail) }}"
                                                                            alt=""> </a> </div>
                                                                <!-- /.image -->
                                                    ...
                                                    <div class="row product-micro-row">
                                                        <div class="col col-xs-5">
                                                            <div class="product-image">
                                                                <div class="image"> <a
                                                                        href="{{ url('product-details/' . $offer->id . '/' . $offer->product_slug_en) }}">
                                                                        <img src="{{ asset($specialDeal->product_thumbnail) }}"
                                                                            alt=""> </a> </div>
                                                                <!-- /.image -->
                                                        ...
                                                        <div class="col col-xs-7">
                                                            <div class="product-info">
                                                                <h3 class="name">
                                                                    <a
                                                                        href="{{ url('product-details/' . $specialDeal->id . '/' . $specialDeal->product_slug_en) }}">
