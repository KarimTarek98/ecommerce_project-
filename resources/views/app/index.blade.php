    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-3 sidebar">
                ...
                <!-- ================================== TOP NAVIGATION ================================== -->
                @include('app.common-sections.categories-sidebar')
                <!-- /.side-menu -->
                <!-- ================================== TOP NAVIGATION : END ================================== -->
                                            ...
                                            <div class="row product-micro-row">
                                                <div class="col col-xs-5">
                                                    <div class="product-image">
                                                        <div class="image"> <a href="{{ url('product-details/' . $offer->id . '/' . $offer->product_slug_en) }}"> <img
                                                                    src="{{ asset($offer->product_thumbnail) }}"
                                                                    alt=""> </a> </div>
                                                        <!-- /.image -->
                ...
                <!-- ============================================== SPECIAL OFFER : END ============================================== -->
                <!-- ============================================== PRODUCT TAGS ============================================== -->
                @include('app.common-sections.product-tags')
                <!-- /.sidebar-widget -->
                <!-- ============================================== PRODUCT TAGS : END ============================================== -->
                <!-- ============================================== SPECIAL DEALS ============================================== -->
                ...
                <div class="sidebar-widget outer-bottom-small wow fadeInUp">
                    ...
                    <div class="sidebar-widget-body outer-top-xs">
                        <div
                            class="owl-carousel sidebar-carousel special-offer custom-carousel owl-theme outer-top-xs">
                            @php
                                $specialDeals = App\Models\Product::where('special_deals', 1)->limit(6)->get();
                            @endphp
                                        ...
                                        <div class="product-micro">
                                            <div class="row product-micro-row">
                                                <div class="col col-xs-5">
                                                    <div class="product-image">
                                                        <div class="image"> <a href="{{ url('product-details/' . $offer->id . '/' . $offer->product_slug_en) }}"> <img
                                                                    src="{{ asset($specialDeal->product_thumbnail) }}"
                                                                    alt=""> </a> </div>
                                                        <!-- /.image -->
                                                ...
                                                <div class="col col-xs-7">
                                                    <div class="product-info">
                                                        ...
                                                        <div class="product-price">
                                                            ...
                                                            <span class="price">
                                                                EGP {{ $specialDeal->discount_price }}
                                                            </span>
                                                            <span class="price-before-discount">
                                                                {{ $specialDeal->selling_price }}
                                                            </span>
                                                            @else
                                                            <span class="price">
                                                                EGP {{ $specialDeal->selling_price }}
                                                            </span>
                                                            @endif
                                                        </div>
                                                        <!-- /.product-price -->
                ...
                <!-- ============================================== Testimonials============================================== -->
                @include('app.common-sections.testimonials')
